...
if __name__ == "__main__":
    ...
    """
Script: transformar_analise.py
Autor: Pessoa 2
Descrição:
    - Limpa e transforma os dados de COVID.
    - Gera métricas derivadas (crescimento diário, média móvel, etc).
    - Une com indicadores socioeconômicos.
    - Exporta o resultado final para analise_final.csv.
"""

def transform_covid(df: pd.DataFrame) -> pd.DataFrame:
    """
    Limpa e transforma os dados de COVID.
    - Remove nulos e negativos.
    - Calcula Casos Ativos, Taxa de Mortalidade.
    - Gera métricas derivadas (crescimento diário e médias móveis).
    """
